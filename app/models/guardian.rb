class Guardian < ActiveRecord::Base
  ...
  # break up long lines for readability
	attr_accessor :address_line_1, :address_line_2, :address_city, :address_state, :address_zip_code,
                :registration_code, :ccsd_id, :relationship_to_student
  attr_accessible :address_line_1, :address_line_2, :address_city, :address_state, :address_zip_code,
                  :email, :preferred_language, :registration_code, :ccsd_id, :relationship_to_student
